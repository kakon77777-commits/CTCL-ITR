...
def test_canonical_geometry_reference_summary():
    ...
    assert auto["boundaries"]["positive_stability_zero_crossings"][0]["estimated_reference_family_weights"]["code"] == 0.5528922561345437
    assert gov["boundaries"]["positive_stability_zero_crossings"][0]["estimated_reference_family_weights"]["code"] == 0.5
