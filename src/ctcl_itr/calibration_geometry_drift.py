...
def compare_surface_geometry(
    ...
    subjects = {subject: _subject_motion(base["subjects"][subject], current["subjects"][subject], families) for subject in ("autonomy", "governance")}
    ...
    return {
        ...
        "base_geometry": {"geometry_id": base["geometry_id"], "source_surface": deepcopy(base.get("source_surface"))},
        "current_geometry": {"geometry_id": current["geometry_id"], "source_surface": deepcopy(current.get("source_surface"))},
