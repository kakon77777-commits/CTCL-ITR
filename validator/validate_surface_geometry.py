...
def main() -> None:
    pairs = [
        ("schemas/calibration-surface-geometry-spec.schema.json", "examples/calibration_surface_geometry_spec.json"),
        ("schemas/calibration-surface-geometry-report.schema.json", "examples/calibration_surface_geometry_report.json"),
    ]
    ...
    regenerated = analyze_surface_geometry(source_surface, load("examples/calibration_surface_geometry_spec.json"))
