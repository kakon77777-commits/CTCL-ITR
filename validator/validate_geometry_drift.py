...
def main() -> None:
    pairs = [
        (
            "schemas/calibration-geometry-drift-spec.schema.json",
            "examples/calibration_geometry_drift_spec.json",
        ),
        (
            "schemas/calibration-geometry-drift-report.schema.json",
            "examples/calibration_geometry_drift_report.json",
        ),
        (
            "schemas/calibration-surface-geometry-report.schema.json",
            "examples/calibration_surface_geometry_report_later.json",
        ),
    ]
    ...
    later_surface = analyze_joint_uncertainty_surface(
        load("examples/calibration_snapshot_base.json"),
        load("examples/calibration_snapshot_later.json"),
        load("examples/calibration_comparison_spec_later.json"),
        load("examples/calibration_joint_surface_spec_later.json"),
    )
    later_geometry = analyze_surface_geometry(
        later_surface,
        load("examples/calibration_surface_geometry_spec_later.json"),
    )
    ...
    regenerated = compare_surface_geometry(
        load("examples/calibration_surface_geometry_report.json"),
        later_geometry,
        load("examples/calibration_geometry_drift_spec.json"),
    )
